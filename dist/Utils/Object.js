...
exports.AreValuesEqual = void 0;
function AreValuesEqual(_valA, _valB) {
    var _a;
    const propertyList = [
        {
            path: '',
    ...
    while (propertyList.length) {
        ...
        const propertyTypeA = (property.A === null || property.A === undefined) ? null : typeof property.A;
        const propertyTypeB = (property.B === null || property.B === undefined) ? null : typeof property.B;
        ...
        if (propertyTypeA === propertyTypeB) {
            switch (propertyTypeA) {
                case 'object': {
                    if (Array.isArray(property.A)) {
                        ...
                        for (const propertyName in property.A) {
                            ...
                            if (!((_a = property.B) === null || _a === void 0 ? void 0 : _a.hasOwnProperty(propertyName))) {
                                return false;
                            }
                ...
                case 'string': {
                    ...
                    const dateMillisA = Date.parse(property.A);
                    const dateMillisB = Date.parse(property.B);
